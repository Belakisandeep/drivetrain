    ...
    <Section title="Customer Satisfaction Is Our Goal" image={{ src: wheels }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
          ...
          Engines & Drivetrain warranty doesn&apos;t cover any attached accessory parts
          such as
        ...
        <p>
          Engines & Drivetrain is also not accountable for any charges associated with
        ...
        <p>
          ...
          unless the replacement is authorized by Engines & Drivetrain during the
    ...
    <Section title="" image={{ src: gearStick, shape: 1 }}>
      <div className="space-y-6 text-base text-neutral-600">
        ...
        <p>
          ...
          or parts that were not diagnosed correctly. Engines & Drivetrain will not
        ...
        <p>
          Used low mileage engine is the best in our knowledge. Engines & Drivetrain
    ...
    <Section title="" image={{ src: engineRepair, shape: 2 }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
          ...
          Engines & Drivetrain is using a VIN compatibility tool to assure that the
        ...
        <p>
          Return or exchange of used engines are authorized by Engines & Drivetrain
          ...
          altered in any way without Engines & Drivetrain written authorization, the
      ...
      <Container className="mt-24">
        <GridList>
          ...
          <GridListItem className="flex" title="">
            ...
            us. Engines & Drivetrain warranty claim representative will work with you to
          ...
          <GridListItem className="flex" title="">
            Engines & Drivetrain permits only original purchasers for any deal or
      ...
      <Container className="mt-24">
        <GridList>
          ...
          <GridListItem className="flex" title="7 ">
            Engines & Drivetrain warranty does not apply for an initial installation.
            Engines & Drivetrain warranty claim must be submitted and authorized by Swap
